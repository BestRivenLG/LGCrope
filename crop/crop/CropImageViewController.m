...
//    generate origin imageview background view;
    ...
    self.originImageBoardView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, SCREENHEIGHT - 88 - 64)];
...
//    generate crop button;
    ...
    self.sureMyView.frame = CGRectMake(0, SCREENHEIGHT - 80, SCREENWIDTH, 73);
